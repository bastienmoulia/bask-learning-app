...
_fallback) {
    ...
    const invokeCall = (request, callOptions, callback, recordResend) => {
        ...
        if (recordResend && ongoingCall instanceof streaming_1.StreamProxy) {
        ...
        funcPromise
            ...
            if (!streaming && retry) {
                ...
                if (retry.retryCodes && retry.retryCodes.length > 0) {
                    ...
                    return (0, retries_1.retryable)(func, thisSettings.retry, thisSettings.otherArgs, thisSettings.apiName, recordResend);
                }
            }
    ...
    if (tracingEnabled) {
        ...
        return (request, callOptions, callback) => {
            return (0, TracerHelper_1.traceCall)(dynamicArgs, staticArgs, (tracedCallback, recordResend) => {
                ...
                return invokeCall(request, callOptions, tracedCallback ?? callback, recordResend);
